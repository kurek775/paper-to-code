...
class StackFrames(gym.ObservationWrapper):
    def __init__(self,env,repeats):
        ...
        self.observation_space = gym.spaces.Box(env.observation_space.low.repeat(repeats,axis=0),
                                                env.observation_space.high.repeat(repeats,axis=0),
                                                dtype=np.float32)
        
        self.stack = collections.deque(maxlen=repeats)
